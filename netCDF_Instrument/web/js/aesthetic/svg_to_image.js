...
$.getScript( "./js/aesthetic/rgbcolor.js" )
.done(function( script, textStatus ) {
  console.log( 'success',textStatus );
})
.fail(function( jqxhr, settings, exception ) {
  console.log('rgb color fail')
});
$.getScript( "./js/aesthetic/StackBlur.js" )
.done(function( script, textStatus ) {
  console.log( 'success',textStatus );
})
.fail(function( jqxhr, settings, exception ) {
  console.log('stack blur fail')
});
$.getScript( "./js/aesthetic/canvg.js" )
.done(function( script, textStatus ) {
  console.log( 'success',textStatus );
})
.fail(function( jqxhr, settings, exception ) {
  console.log('canvg fail')
});
